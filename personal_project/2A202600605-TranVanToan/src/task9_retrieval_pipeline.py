...
def retrieve(
    ...
    """
    # Bước 1: Chạy semantic và lexical search song song (tuần tự ở đây cho đơn giản và ổn định)
    dense_results = semantic_search(query, top_k=top_k * 2)
    sparse_results = lexical_search(query, top_k=top_k * 2)
    
    # Bước 2: Trộn kết quả bằng Reciprocal Rank Fusion (RRF)
    ...
    # Bước 4: Kiểm tra ngưỡng điểm -> Gọi cơ chế dự phòng sang PageIndex nếu cần
